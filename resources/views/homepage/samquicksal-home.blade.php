...
<body>
    <header class="bg-adminLoginTextColor flex items-center flex-wrap font-Roboto">
        ...
        <div class="hidden top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto" id="navigation">
            <div class="lg:inline-flex lg:flex-row lg:ml-auto flex flex-col">
                <a href="/restaurant" target="_blank" class="lg:inline-flex lg:w-auto px-3 py-2 mx-5 rounded text-gray-200 hover:text-white transition duration-200 hover:bg-submitButton">Be Our Partner</a>
                <a href="#" class="lg:inline-flex lg:w-auto px-3 py-2 rounded text-gray-200 hover:text-white mx-5 hover:font-bold transition duration-200 hover:bg-submitButton">Login</a>
                <a href="#" class="lg:inline-flex lg:w-auto px-3 py-2 rounded text-gray-200 hover:text-white mx-5 mr-8 hover:font-bold transition duration-200 hover:bg-submitButton">Signup</a>
            </div>
        </div>
    </header>
    ...
    <section>
        <div class="bg-white grid lg:grid-cols-2 py-32 lg:pl-20 items-center justify-center w-9/12 mx-auto">
            <div class="lg:ml-5 mb-5 text-center lg:text-left w-9/12">
    ...
    <section class="bg-adminViewAccountHeaderColor2 w-full h-96">
    ...
    <section  class="grid lg:grid-cols-2 lg:py-36 relative">
            ...
            <div class="hidden overflow-hidden absolute md:block rounded-lg bg-indigo-200 top-80 h-80 w-6/12  right-0 z-0"></div>
    </section>
    ...
    <div class="bg-gradient-to-b from-white to-headerBgColor">
        ...
        <section>
            <div class="grid lg:grid-cols-2 p-4 mt-32 pb-20">
                <div class="flex justify-center items-center">
                ...
                <div class="font-Montserrat flex justify-center items-center font-bold flex-col">
                    <p class="mb-4 lg:text-3xl text-lg text-center">Download The Samquicksal App Now!</p>
    ...
    <footer class="text-blueGray-700 transition duration-500 ease-in-out transform bg-adminViewAccountHeaderColor2">
