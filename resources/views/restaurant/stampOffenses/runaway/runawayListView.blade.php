...
<div class="container mx-auto">
                ...
                @for ($i=0; $i<sizeOf($custMainOffenses); $i++)
                    @if ($count % 2 == 0)
                        <div class="grid grid-cols-10 py-2 text-center bg-manageFoodItemHeaderBgColor">
                            ...
                            <div class="col-span-1">
                                <a href="/restaurant/stamp-offenses/offenses/runaway/{{ $custMainOffenses[$i]['id'] }}">
    ...
    @if ($storeName == null)
        <div class="mx-auto w-11/12 mt-1 grid grid-cols-1 items-center bg-manageFoodItemHeaderBgColor h-14 shadow-xl rounded-lg">
            <div class="text-center text-multiStepBoxColor uppercase">There are no runaway customer offenses as of now</div>
        </div>
    @endif
</div>
@endsection