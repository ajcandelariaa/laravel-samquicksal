                ...
                @csrf
                    ...
                    <div class="bg-white">
                        <div class="grid grid-cols-stampCardGrid w-9/12 gap-y-5 mx-auto py-10">
                            ...
                            <div class="text-left text-submitButton">:</div>
                            <div class="">
                                <select name="offenseType" id="offenseType" onchange="cancellationBlockDays();" class="w-full py-1 border border-gray-400 rounded-sm text-sm text-gray-700 focus:outline-none  focus:border-black">
