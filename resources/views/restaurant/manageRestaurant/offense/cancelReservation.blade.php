            ...
            <div class="col-span-1 bg-manageRestaurantSidebarColorActive pb-8 shadow-adminDownloadButton">
                ...
                @csrf
                    <div class="w-11/12 mx-auto">
                        <div class="uppercase font-bold text-white text-xl py-3">Cancel Reservation Offense</div>
                    </div>
                    <div class="bg-white">
                        <div class="grid grid-cols-stampCardGrid w-9/12 gap-y-5 mx-auto py-10">
                            ...
                            <div class="">
                                <input type="text" name="numberOfCancellation" class="w-full border border-gray-400 rounded-sm text-sm text-gray-700 focus:outline-none  focus:border-black">
                            ...
                            <div class="text-left text-submitButton">:</div>
                            <div class="">
                                <select name="offenseType" id="offenseType" onchange="cancellationBlockDays();" class="w-full border border-gray-400 rounded-sm text-sm text-gray-700 focus:outline-none  focus:border-black">
            ...
            <div class="col-span-1 bg-manageRestaurantSidebarColorActive pb-8 shadow-adminDownloadButton">
                ...
                <div class="bg-adminViewAccountHeaderColor2 grid grid-cols-1 gap-y-2">
                    ...
                    <div class="grid grid-cols-2 w-full items-center bg-white pl-5 pr-11 py-5">
                        ...
                        <p class="col-span-1 place-self-end">{{ $cancellation->noOfDays }}</p>
                    </div>
                    <div class="grid grid-cols-2 w-full items-center bg-white pl-5 pr-11 py-5">
