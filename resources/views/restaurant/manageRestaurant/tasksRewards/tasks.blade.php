...
<div class="container mx-auto tasks">
    ...
    <div class="w-11/12 mx-auto my-10">
        <div class="grid grid-cols-2 gap-5 items-center">
            ...
            <div class="col-span-1 bg-white shadow-adminDownloadButton rounded-lg p-3 relative">
                ...
                <div class="absolute top-3 right-3">
                    <button id="btn-task1" class="btn-task1 text-white bg-manageRestaurantSidebarColorActive inline-block text-center leading-9 w-9 h-9 rounded-full"><i class="fas fa-edit"></i></button>
                </div>
            </div>
            ...
            <div class="col-span-1 bg-white shadow-adminDownloadButton rounded-lg p-3 relative">
                ...
                <div class="absolute top-3 right-3">
                    <button id="btn-task2" class="btn-task2 text-white bg-manageRestaurantSidebarColorActive inline-block text-center leading-9 w-9 h-9 rounded-full"><i class="fas fa-edit"></i></button>
                </div>
            </div>
            ...
            <div class="col-span-1 bg-white shadow-adminDownloadButton rounded-lg p-3 relative">
                ...
                <div class="absolute top-3 right-3">
                    <button id="btn-task3" class="btn-task3 text-white bg-manageRestaurantSidebarColorActive inline-block text-center leading-9 w-9 h-9 rounded-full"><i class="fas fa-edit"></i></button>
                </div>
            </div>
        ...
        <div class="task1-form">
            ...
            <h1 class="text-center text-submitButton font-bold text-2xl">Spend n<sup>th</sup> pesos in 1 visit only</h1>
            <form action="/restaurant/manage-restaurant/task-rewards/tasks/edit/task1" method="POST">
                ...
                <div class="grid grid-cols-stampCardGrid w-5/12 gap-y-5 mx-auto mt-10">
                    ...
                    <div class="col-span-1">
                        <input type="text" name="task1" value="{{ $tasks[0]->taskInput }}" class="border focus:border-black w-full py-1 px-2 text-sm focus:outline-non text-gray-700" required>
                    </div>
                </div>
        ...
        <div class="task2-form">
            ...
            <form action="/restaurant/manage-restaurant/task-rewards/tasks/edit/task2" method="POST">
                ...
                <div class="grid grid-cols-stampCardGrid w-5/12 gap-y-5 mx-auto mt-10">
                    ...
                    <div class="col-span-1">:</div>
                    <div class="col-span-1">
                        <input type="text" name="task2" value="{{ $tasks[1]->taskInput }}" class="border focus:border-black w-full py-1 px-2 text-sm focus:outline-non text-gray-700" required>
                    </div>
                </div>
                <div class="text-center mt-10">
                    <button class="bg-submitButton text-white rounded-full w-32 h-10 text-sm" type="submit">Update</button>
        ...
        <div class="task3-form">
            ...
            <h1 class="text-center text-submitButton font-bold text-2xl">Order n<sup>th</sup> add on/s per visit</h1>
            <form action="/restaurant/manage-restaurant/task-rewards/tasks/edit/task3" method="POST">
                ...
                <div class="grid grid-cols-stampCardGrid w-5/12 gap-y-5 mx-auto mt-10">
                    ...
                    <div class="col-span-1">:</div>
                    <div class="col-span-1">
                        <input type="text" name="task3" value="{{ $tasks[2]->taskInput }}" class="border focus:border-black w-full py-1 px-2 text-sm focus:outline-non text-gray-700" required>
                    </div>
                </div>
                <div class="text-center mt-10">
                    <button class="bg-submitButton text-white rounded-full w-32 h-10 text-sm" type="submit">Update</button>
