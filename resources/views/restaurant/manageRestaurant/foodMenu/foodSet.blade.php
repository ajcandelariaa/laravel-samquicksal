...
<div class="container mx-auto food-item">
    ...
    <div class="w-11/12 mx-auto mt-10">
        <div class="flex justify-between w-full">
            ...
            <div>
                <button id="btn-add-item" class="bg-submitButton text-white w-36 h-9 rounded-md"><i class="fas fa-plus mr-3"></i>Food Set</button>
            </div>
        </div>
        ...
        <div class="create-form" id="create-form">
            ...
            <h1 class="text-center text-submitButton font-bold text-2xl">Create Food Set</h1>
