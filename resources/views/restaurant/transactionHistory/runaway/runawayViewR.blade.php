...
<div class="container mx-auto">
    <div class="w-11/12 mx-auto mt-10 pb-2">
        <a href="/restaurant/transaction-history/runaway/reserve" class="text-submitButton uppercase font-bold">
            <i class="fas fa-chevron-left mr-2"></i>Back
        </a>
    </div>
    <div class="w-11/12 mx-auto mt-5 font-Montserrat bg-white mb-10">
        <div class="bg-manageRestaurantSidebarColorActive">
            <div class="uppercase font-bold text-white ml-8 text-xl py-3">Runaway Customer Reserve Details</div>
        </div>
                    ...
                    <div class="col-span-2 row-span-5 bg-manageFoodItemHeaderBgColor">
                        ...
                        <div class="py-5 w-11/12 mx-auto">
                            <div class="grid grid-cols-3 mt-2">
                                ...
                                <p class="justify-self-end col-span-1 font-bold">{{ (number_format($orderSet->orderSetPrice * $customerReserve->numberOfPersons, 2, '.')) }} <span class="text-xs text-manageRestaurantSidebarColor font-normal">Php</span></p>
                            </div>
