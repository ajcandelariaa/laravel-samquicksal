...
<div class="container mx-auto">
    ...
    <div class="w-11/12 mx-auto mt-5 font-Montserrat bg-white mb-10">
        <div class="bg-manageRestaurantSidebarColorActive">
            <div class="uppercase font-bold text-white ml-8 text-xl py-3">Declined Customer Reserve Details</div>
        </div>
                    ...
                    <div class="col-span-2">
                        <div class="grid grid-cols-2">
                            ...
                            <div>
                                ...
                                <p class="mt-2">Declined Time: <span class="font-bold">{{ $cancelledTime }}</span></p>
