...
<div class="container mx-auto">
    <div class="w-11/12 mx-auto mt-10 pb-2">
        <a href="/restaurant/transaction-history/cancelled/reserve" class="text-submitButton uppercase font-bold">
            <i class="fas fa-chevron-left mr-2"></i>Back
        </a>
    </div>
    <div class="w-11/12 mx-auto mt-5 font-Montserrat bg-white mb-10">
        <div class="bg-manageRestaurantSidebarColorActive">
            <div class="uppercase font-bold text-white ml-8 text-xl py-3">No Show Customer Reserve Details</div>
        </div>
                    ...
                    <div class="col-span-2">
                        <div class="grid grid-cols-2">
                            <div>
                                ...
                                <p class="mt-2">No Show Date: <span class="font-bold">{{ $cancelledDate }}</span></p>
                            ...
                            <div>
                                ...
                                <p class="mt-2">No Show Time: <span class="font-bold">{{ $cancelledTime }}</span></p>
