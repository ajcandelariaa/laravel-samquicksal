    ...
    <div class="w-11/12 mx-auto mt-5 font-Montserrat bg-white">
        ...
        <div class="declined-form">
            ...
            <form action="/restaurant/live-transaction/customer-booking/queue/decline/{{ $customerQueue->id }}" method="POST" id="declinedForm">
                ...
                <div class="text-center mt-10">
                    <button id="btnDeclined" class="bg-submitButton text-white hover:bg-darkerSubmitButton hover:text-gray-300 rounded-md w-32 h-10 text-sm uppercase font-bold transition duration-200 ease-in-out" type="submit">Submit</button>
                </div>
            </form>
        </div>
        ...
        <div class="approved-form">
            ...
            <form action="/restaurant/live-transaction/customer-booking/queue/approve/{{ $customerQueue->id }}" method="POST" id="approvedForm">
                @csrf
                <div class="w-11/12 mx-auto mt-10 text-center">
                    <input type="text" name="noOfPersons" id="noOfPersons" value="{{ $customerQueue->numberOfPersons }}" hidden>
                ...
                <div class="text-center mt-10">
                    <button id="btnApproved" class="bg-submitButton text-white hover:bg-darkerSubmitButton hover:text-gray-300 rounded-md w-32 h-10 text-sm uppercase font-bold transition duration-200 ease-in-out" type="submit">Submit</button>
                </div>
            </form>
        </div>
