...
<div class="container mx-auto font-Montserrat mb-10 booking">
    ...
    <div class="w-11/12 mx-auto mt-10 pb-2 grid grid-cols-2">
        <a href="/restaurant/live-transaction/approved-customer/reserve" class="text-submitButton uppercase font-bold"><i class="fas fa-chevron-left mr-2"></i>Back</a>
       

        @if (!$canValidate)
            <p class="text-submitButton uppercase font-bold text-right">Please validate the customer 15 minutes before his/her reservation</p>
        @elseif ($remainingTables < $customerReserve->numberOfTables)
    ...
    <div class="w-11/12 mx-auto mt-5 font-Montserrat bg-white">
            ...
            <div class="justify-self-end text-white py-3 ml-3">
                ...
                @if ($customerReserve->status == "approved")
                    ...
                    @elseif ($remainingTables < $customerReserve->numberOfTables)
                        <button type="button" class="px-8 py-2 bg-manageRestaurantSidebarColor cursor-not-allowed" disabled>Validate</button>
                    @else
                        <a href="/restaurant/live-transaction/approved-customer/reserve/validate/{{ $customerReserve->id }}" class="btn-validate px-8 py-2 bg-postedStatus ml-2">Validate</a>
                    @endif
                @else
                    <a href="/restaurant/live-transaction/approved-customer/reserve/no-show/{{ $customerReserve->id }}" class="btn-no-show px-8 py-2 bg-adminDeleteFormColor ml-2">No show</a>
        ...
        <div class="w-11/12 mx-auto py-10">
            <div class="grid grid-cols-3 gap-x-3">
                ...
                <div class="col-span-1 self-stretch">
                    <div class="bg-adminViewAccountHeaderColor2">
                        <div class="uppercase font-bold text-center text-xl py-4">Reservation Status</div>
                    </div>
        ...
        <div class="admit-form">
            ...
            <form action="/restaurant/live-transaction/approved-customer/reserve/admit/{{ $customerReserve->id }}" method="POST" id="admitForm">
                @csrf
