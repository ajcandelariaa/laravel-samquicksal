...
<div class="bg-gray-200 w-full">
    <div class="container mx-auto">
        <div class="w-11/12 mx-auto mt-10 grid grid-cols-12 gap-3">
            {{-- ROW 1 --}}
            <div class="bg-tableBgHeader w-full h-14 grid items-center shadow-lg col-span-full">
                <div class="text-black text-center font-medium">Dashboard</div>
            </div>

            {{-- ROW 2 --}}
            <div class="bg-white w-full h-48 shadow-xl col-span-4 relative">
                <div class="grid text-black text-center items-center w-full h-36 text-7xl font-medium">28</div>
                <div class="bg-black w-full absolute bottom-0 h-12 grid text-white text-center items-center">Restaurant Accounts</div>
            </div>
            <div class="bg-white w-full h-48 shadow-xl col-span-4 relative">
                <div class="grid text-black text-center items-center w-full h-36 text-7xl font-medium">14</div>
            ...
            <div class="bg-white w-full h-48 shadow-xl col-span-8 relative">
                <div class="grid text-black text-center items-center w-full h-36 text-7xl font-medium">152</div>
            ...
            <div class="bg-black w-full h-50 shadow-xl col-span-4 rounded-3xl -mt-3">
                ...
                <div class="h-32 w-full bg-gray-300 mt-3">
                    <div class="pt-3">
                        <div class="w-full h-7 bg-white mb-2">
                            <div class="w-11/12 h-7 mx-auto grid grid-cols-3 items-center">
                                <p class="text-xs col-span-2"><i class="fas fa-file-signature mr-2"></i>New Restaurant Applicant</p>
                                <p class="text-gray-600 text-xs col-span-1 justify-self-end">1 hr ago</p>
                            </div>
                        </div>
                        <div class="w-full h-7 bg-white mb-2">
                            <div class="w-11/12 h-7 mx-auto grid grid-cols-3 items-center">
                                <p class="text-xs col-span-2"><i class="fas fa-users mr-2"></i>New Customer Account</p>
                                <p class="text-gray-600 text-xs col-span-1 justify-self-end">1 hr ago</p>
                            </div>
                        </div>
                        <div class="w-full h-7 bg-white">
                            <div class="w-11/12 h-7 mx-auto grid grid-cols-3 items-center">
                                <p class="text-xs col-span-2"><i class="fas fa-user-tie mr-2"></i>New Registered Restaurant</p>
                                <p class="text-gray-600 text-xs col-span-1 justify-self-end">1 hr ago</p>
                            </div>
                        </div>
                    </div>
